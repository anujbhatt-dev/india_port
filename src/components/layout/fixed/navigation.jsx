      ...
      return (
           <div className="navigation">
               ...
               <div className={this.state.on?"navigation__items navon":"navigation__items navoff"}>
                   ...
                   {this.props.location.pathname==="/"||this.props.location.pathname==="/about"?<a className="navigation__items_item navigation__items_item" href="/services">Service</a>:<NavLink activeStyle={{color:"white",background:"#FFBF29"}} exact to="/services" className="navigation__items_item navigation__items_item">Services</NavLink>}
