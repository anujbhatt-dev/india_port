      ...
      return (
           <div className="navigation">
               ...
               <div className={this.state.on?"navigation__items navon":"navigation__items navoff"}>
                   ...
                   {this.props.location.pathname==="/"?<a className="navigation__items_item navigation__items_item" href="/invoice">Invoice</a>:<NavLink activeStyle={{color:"white",background:"#FFBF29"}} exact to="/invoice" className="navigation__items_item navigation__items_item">Invoice</NavLink>}
                   {this.props.location.pathname==="/"?<a className="navigation__items_item navigation__items_item" href="/services">Service</a>:<NavLink activeStyle={{color:"white",background:"#FFBF29"}} exact to="/services" className="navigation__items_item navigation__items_item">Services</NavLink>}
                   {this.props.location.pathname==="/"?<a className="navigation__items_item navigation__items_item" href="/about">About</a>:<NavLink activeStyle={{color:"white",background:"#FFBF29"}} exact to="/about" className="navigation__items_item navigation__items_item">About</NavLink>}
                   {this.props.location.pathname==="/"?<a className="navigation__items_item navigation__items_item" href="/contact">Contact</a>:<NavLink activeStyle={{color:"white",background:"#FFBF29"}} exact to="/contact" className="navigation__items_item navigation__items_item">Contact</NavLink>}
                   {this.props.location.pathname==="/"?<a className="navigation__items_item navigation__items_item" href="/exim">Exim</a>:<NavLink activeStyle={{color:"white",background:"#FFBF29"}} exact to="/exim" className="navigation__items_item navigation__items_item">Exim</NavLink>}
