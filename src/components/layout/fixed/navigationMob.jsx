      ...
      return (
          <div className="navMob">
                ...
                <div className={this.state.open?"openNav navMob__items ":"closeNav navMob__items "}>
                    ...
                    <NavLink onClick={this.toggleHandler} activeStyle={{color:"white",background:"#FFBF29"}} exact to="/contact" className="navigation__items_item navigation__items_item">Reach</NavLink>
