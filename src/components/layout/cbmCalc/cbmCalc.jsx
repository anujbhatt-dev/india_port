             ...
             {!this.props.mobile?
                ...
                <table cellspacing="15" className="cbmCalc__table">
                   ...
                   <tbody>
                      {[1,2,3,4,5].map(id=>
                      <tr>
                         <td className="cbmBack__table-sr" style={{position:"relative"}}  ><p className="cbmCalc__p">{this.state.valids[id]?<p>{id}<i onClick={this.state.valids[id]?()=>{this.invalidate(id)}:null}  style={{position:"absolute",top:"0.1rem",right:"0.1rem",fontSize:"2rem"}} className="fa fa-times" aria-hidden="true"></i></p>:<i className="fa fa-plus" aria-hidden="true"></i>}</p></td>
